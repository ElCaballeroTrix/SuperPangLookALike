...
void   CORE_RenderSprite(const vec2 &p0, const vec2 &p1, GLuint texid, double xCoordinates = 0.0, double yCoordinates = 0.0, double sizePercentageX = 1.0, double sizePercentageY = 1.0);
//-----------------------------------------------------------------------------
// Render a Sprite.
